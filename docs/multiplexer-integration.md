...
When OpenCode launches child agent sessions, oh-my-opencode-air can open panes for those sessions automatically.
...
Edit `~/.config/opencode/oh-my-opencode-air.json` (or `.jsonc`):
